    ...
    return (
        <main className="container mx-auto py-4  ">
            <div className=" rounded-lg  p-6 w-full md:w-80 lg:w-96">
                ...
                <div className="flex bg-[#FCE4E4] p-1 w-24 rounded-md">
                    ...
                    <span className="font-mono pl-2 font-bold text-red-600  ml-2">{totalExpenses}</span>
                </div>
                <div className="h-[310px]  w-full md:w-[120%]">
